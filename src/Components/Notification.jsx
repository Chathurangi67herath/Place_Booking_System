...
// import { Card, List, ListItem, Badge, Button } from "@material-tailwind/react";
...
// // Optional: color mapping for notification types
// const typeColors = {
...
//           <Button size="sm" variant="text" className="!p-2">View All</Button>
//         </Badge>
//       </div>
//       <List>
//         {notifications.map((n) => (
//           <ListItem key={n.id} className={`grid items-center gap-3 ${typeColors[n.type]} rounded mb-1`}>
//             {/* You can add an icon here based on type if you want */}
//             <span>{n.message}</span>
//           </ListItem>
//         ))}
//       </List>
